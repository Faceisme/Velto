...
struct GeneralSettingsPage: View {
    ...
    var body: some View {
                ...
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    GroupCard(padding: EdgeInsets(top: 16, leading: 20, bottom: 16, trailing: 20)) {
                        VStack(alignment: .leading, spacing: 14) {
                            Text("配置文件几乎包含全部模块设置:鼠标手势、鼠标控制、窗口管理、触控板手势、切换器、输入法切换、按键映射、截图、网络监控与增强Finder,以及识别参数和菜单栏等通用偏好;开机自动启动属于系统登录项,不随配置导入导出。")
        ...
        .confirmationDialog(
            ...
            Text("会覆盖鼠标手势、鼠标控制、窗口管理、触控板手势、切换器、输入法切换、按键映射、截图、网络监控、增强Finder 及通用偏好等全部模块配置。建议先导出当前配置作为备份。")
        }
